...
export function DemoLayout({ children }: DemoLayoutProps) {
  ...
  const [mobileBackendOpen, setMobileBackendOpen] = useState(false);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex items-center gap-2">
              ...
              {role && (
                <>
                  ...
                  {/* Mobile: Backend toggle button */}
                  <button
                    onClick={() => setMobileBackendOpen(!mobileBackendOpen)}
                    className={`md:hidden flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                      mobileBackendOpen
      ...
      <main className="flex-1 flex overflow-hidden relative">
        {/* Mobile view - with optional backend panel */}
        <div className="md:hidden flex-1 flex flex-col overflow-hidden">
          {/* Mobile backend panel (slide-up from bottom) */}
          {mobileBackendOpen && (
            <div className="h-[45%] bg-gray-900 border-b border-gray-700 flex flex-col">
              <div className="bg-gray-800 px-3 py-2 flex items-center justify-between border-b border-gray-700 flex-shrink-0">
                <span className="text-sm text-gray-300 font-medium">AI Backend</span>
                <div className="flex items-center gap-1">
                  ...
                  <button
                    onClick={() => setMobileBackendOpen(false)}
